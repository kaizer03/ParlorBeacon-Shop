...
public class Booking_Shop extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.mybookshop) {
            startActivity(new Intent(Booking_Shop.this,Booking_Shop.class));
        } else if (id == R.id.myshop) {
            startActivity(new Intent(Booking_Shop.this,MyShop.class));
        } else if (id == R.id.myemployeeshop) {
            startActivity(new Intent(Booking_Shop.this,Employee_Shop.class));
        } else if (id == R.id.shopdetail) {
            startActivity(new Intent(Booking_Shop.this,Detail_Shop.class));
        } else if (id == R.id.aboutus) {
            startActivity(new Intent(Booking_Shop.this,About_Us.class));
        } else if (id == R.id.contactus) {
            startActivity(new Intent(Booking_Shop.this,ContactUs.class));
        }
