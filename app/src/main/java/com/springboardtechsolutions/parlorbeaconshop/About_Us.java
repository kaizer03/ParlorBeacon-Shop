...
public class About_Us extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView1 = (TextView)headerView.findViewById(R.id.navaboutshoptext);
        textView1.setText("Hello "+loadData2());

        TextView textView;
        textView = (TextView)findViewById(R.id.AboutComp);
        textView.setText(R.string.AboutCompany);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.uf) {
            startActivity(new Intent(About_Us.this,UpcomingFeatures.class));
            return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.mybookshop) {
            ...
            startActivity(new Intent(About_Us.this,Employee_Shop.class));
        } else if (id == R.id.shopdetail) {
            startActivity(new Intent(About_Us.this,Detail_Shop.class));
        } else if (id == R.id.aboutus) {
            startActivity(new Intent(About_Us.this,About_Us.class));
        } else if (id == R.id.contactus) {
            startActivity(new Intent(About_Us.this,ContactUs.class));
        }
        finish();
