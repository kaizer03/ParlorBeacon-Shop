...
public class Forgot$$ViewBinder<T extends com.springboardtechsolutions.parlorbeaconshop.Forgot> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492985, "field 'emailtext'");
    target.emailtext = finder.castView(view, 2131492985, "field 'emailtext'");
    view = finder.findRequiredView(source, 2131492986, "method 'onClick1'");
